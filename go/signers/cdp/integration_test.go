...
// the environment — the Go analog of the Rust tests/test_cdp_integration.rs,
...
// CDP's signMessage endpoint only accepts UTF-8 payloads, so this signs the
// same literal string as the Rust test rather than raw transaction bytes.
